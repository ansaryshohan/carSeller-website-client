    ...
    <>
      ...
      <div className="modal">
        <div className="modal-box relative">
          ...
          <input type="text" value={'Product Price :  $'+ selling_price} className="input input-bordered w-full " disabled  />
          <input type="number" placeholder="Phone Number" className="input input-bordered  w-full " name='phone' />
          <input type="text" placeholder="Preferred Meeting Location" className="input  input-bordered w-full " name='locaton' />
          <input 
          type="submit"
           value=" Book Your Car" 
