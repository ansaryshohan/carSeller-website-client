        ...
        <div className=" px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen md:px-24 lg:px-8">
          <div className="relative flex items-center justify-between lg:p-1">
              ...
              <li>
                {
                  user && user.uid ?
                    <NavLink
                      to="/login"
                      className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-[#6D67E4] transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                      aria-label="Sign Out"
                      title="Sign Out"
            ...
            <div className="lg:hidden  ">
              ...
              >
                <svg className="w-5 text-[#8E54E9]" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <Link
                          ...
                          aria-label="Company"
                          title="Company"
                          className="flex items-center gap-2  mr-4 w-1/4"
                        >
                          <img src={logo} alt="" className=' w-2/6 ' />
                          <span className="ml-2 text-2xl font-bold tracking-wide text-[#6D67E4] uppercase">
